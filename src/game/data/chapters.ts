    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_1',
        name: '博物馆苏醒',
        description: '在博物馆大厅中醒来，发现周围陈列着各种琥珀展品',
        icon: '🏛️',
        order: 1,
        type: 'story',
        targetId: 'exhibition_1',
        isCompleted: false,
        hint: '探索大厅，寻找关于琥珀的线索'
      },
      {
        ...
        chapterId: 'chapter_1',
        name: '发现琥珀吊坠',
        description: '在西侧展厅找到封存着小昆虫的琥珀吊坠',
        icon: '💎',
        order: 2,
        type: 'clue',
        targetId: 'clue_2',
      ...
      },
      {
        ...
        chapterId: 'chapter_1',
        name: '医院手环的秘密',
        description: '在东侧展厅找到印有"林琥珀"名字的医院手环',
        icon: '🏥',
        order: 4,
        type: 'clue',
        targetId: 'clue_4',
      ...
      },
      {
        ...
        chapterId: 'chapter_1',
        name: '解开古老密码锁',
        description: '根据照片上的年份1998，解开西侧展厅的密码锁',
        icon: '🔐',
        order: 5,
        type: 'mechanism',
        targetId: 'mech_1',
        isCompleted: false,
        hint: '密码是老照片上的年份',
        relatedMechanismIds: ['mech_1'],
        relatedClueIds: ['clue_1'],
        exhibitionId: 'exhibition_2'
      },
      {
        id: 'kp_ch1_6',
        chapterId: 'chapter_1',
        name: '进入珍藏馆',
        description: '密码锁开启，通往珍藏馆的大门打开了',
        icon: '🚪',
        order: 6,
        type: 'exhibition',
        targetId: 'exhibition_4',
        isCompleted: false,
        hint: '前往新解锁的珍藏馆',
    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_2',
        name: '珍藏馆探索',
        description: '进入爷爷的珍藏馆，这里陈列着最珍贵的收藏',
        icon: '🏛️',
        order: 1,
        type: 'exhibition',
        targetId: 'exhibition_4',
      ...
      },
      {
        ...
        chapterId: 'chapter_2',
        name: '停止的怀表',
        description: '发现停在3点15分的怀表，这是爷爷留给琥珀的生日礼物',
        icon: '⌚',
        order: 4,
        type: 'clue',
        targetId: 'clue_9',
      ...
      },
      {
        ...
        chapterId: 'chapter_2',
        name: '解开记忆机关',
        description: '按照记忆顺序排列琥珀吊坠、日记残页、医院手环',
        icon: '🧩',
        order: 5,
        type: 'mechanism',
        targetId: 'mech_2',
        isCompleted: false,
        hint: '按照记忆的时间顺序排列',
        relatedMechanismIds: ['mech_2'],
        relatedClueIds: ['clue_2', 'clue_3', 'clue_4'],
        exhibitionId: 'exhibition_4'
      },
      {
        id: 'kp_ch2_6',
        chapterId: 'chapter_2',
        name: '回忆长廊',
        description: '进入金色的回忆长廊，两侧封存着无数美好的记忆',
        icon: '✨',
        order: 6,
        type: 'exhibition',
        targetId: 'exhibition_5',
        isCompleted: false,
        hint: '探索回忆长廊，寻找修复室的钥匙',
      ...
      },
      {
        ...
        chapterId: 'chapter_2',
        name: '修复室之门',
        description: '根据怀表停止的时间315，解开修复室之门的密码',
        icon: '🚪',
        order: 8,
        type: 'mechanism',
        targetId: 'mech_3',
        isCompleted: false,
        hint: '密码是怀表停止的时间',
        relatedMechanismIds: ['mech_3'],
        relatedClueIds: ['clue_9', 'clue_6'],
        exhibitionId: 'exhibition_5'
      }
    ]
  },
    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_3',
        name: '进入修复室',
        description: '踏入神秘的文物修复工作室，空气中弥漫着化学试剂的气味',
        icon: '🔧',
        order: 1,
        type: 'exhibition',
        targetId: 'exhibition_6',
        isCompleted: false,
        hint: '收集修复青铜鼎所需的专业工具',
      ...
      },
      {
        ...
        chapterId: 'chapter_3',
        name: '收集修复工具',
        description: '收集精细砂纸、文物修复胶、青铜补配粉等5件专业修复工具',
        icon: '🧰',
        order: 2,
        type: 'clue',
        targetId: 'clue_11',
      ...
      },
      {
        ...
        chapterId: 'chapter_3',
        name: '青铜鼎修复',
        description: '按照正确的修复顺序，亲手修复破损的青铜鼎',
        icon: '🏺',
        order: 3,
        type: 'mechanism',
        targetId: 'mech_4',
        isCompleted: false,
        hint: '按照打磨、粘结、补配、抛光的顺序操作',
        relatedMechanismIds: ['mech_4'],
        relatedClueIds: ['clue_11', 'clue_12', 'clue_13', 'clue_14', 'clue_15'],
        exhibitionId: 'exhibition_6'
      },
      {
        ...
        chapterId: 'chapter_3',
        name: '青铜珍品馆',
        description: '修复完成的青铜鼎被移至青铜珍品馆展出',
        icon: '✨',
        order: 4,
        type: 'exhibition',
        targetId: 'exhibition_7',
        isCompleted: false,
        hint: '欣赏修复后的青铜鼎',
      ...
      },
      {
        ...
        chapterId: 'chapter_3',
        name: '商周密码',
        description: '根据古籍记载，解开商周时期开始的年份1046',
        icon: '🔐',
        order: 5,
        type: 'mechanism',
        targetId: 'mech_5',
      ...
      },
      {
        ...
        chapterId: 'chapter_3',
        name: '双馆之门开启',
        description: '历史馆与艺术馆的大门缓缓打开，双馆并行调查即将开始',
        icon: '🚪',
        order: 6,
        type: 'story',
        targetId: 'chapter_4',
    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_4',
        name: '双馆探索开始',
        description: '历史馆与艺术馆大门开启，双馆并行调查正式开始',
        icon: '🏛️',
        order: 1,
        type: 'story',
        targetId: 'chapter_4',
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '历史馆·青铜王朝',
        description: '探索历史馆第一展区，寻找青铜鼎铭文拓片',
        icon: '🏺',
        order: 2,
        type: 'exhibition',
        targetId: 'exhibition_history_1',
        isCompleted: false,
        hint: '收集历史馆的线索',
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '艺术馆·琥珀殿堂',
        description: '探索艺术馆第一展区，寻找琥珀雕件珍品',
        icon: '💎',
        order: 3,
        type: 'exhibition',
        targetId: 'exhibition_art_1',
        isCompleted: false,
        hint: '收集艺术馆的线索',
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '联动机关·青铜琥珀锁',
        description: '整合两馆线索，解开第一阶段联动机关',
        icon: '🔗',
        order: 4,
        type: 'mechanism',
        targetId: 'mech_linked_1',
        isCompleted: false,
        hint: '需要同时收集历史馆和艺术馆的线索',
        relatedMechanismIds: ['mech_linked_1'],
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '历史馆·礼乐厅',
        description: '探索礼乐厅，寻找编钟乐谱',
        icon: '🎵',
        order: 5,
        type: 'exhibition',
        targetId: 'exhibition_history_2',
        isCompleted: false,
        hint: '继续深入历史馆',
        relatedClueIds: ['clue_h3', 'clue_shared_1'],
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '艺术馆·时光画廊',
        description: '探索时光画廊，寻找油画《青铜与琥珀》',
        icon: '🎨',
        order: 6,
        type: 'exhibition',
        targetId: 'exhibition_art_2',
        isCompleted: false,
        hint: '继续深入艺术馆',
        relatedClueIds: ['clue_a3', 'clue_shared_1'],
      ...
      },
      {
        ...
        chapterId: 'chapter_4',
        name: '联动机关·音律调色锁',
        description: '解开第二阶段联动机关，揭示礼乐与画作的呼应',
        icon: '🔐',
        order: 7,
        type: 'mechanism',
        targetId: 'mech_linked_2',
        isCompleted: false,
        hint: '按照礼乐节奏与画作色调交替排列',
        relatedMechanismIds: ['mech_linked_2'],
        relatedClueIds: ['clue_h3', 'clue_a3', 'clue_shared_1']
      },
      {
        id: 'kp_ch4_8',
        chapterId: 'chapter_4',
        name: '共享线索·礼乐铭文',
        description: '合璧解读工匠族谱与艺术家手札，揭示家族传承秘密',
        icon: '🔗',
        order: 8,
        type: 'clue',
        targetId: 'clue_shared_1',
        isCompleted: false,
        hint: '需要同时拥有工匠族谱和艺术家手札',
        relatedClueIds: ['clue_shared_1']
      },
      {
        id: 'kp_ch4_9',
        chapterId: 'chapter_4',
        name: '共享线索·铸造图谱',
        description: '交融解读铸造图谱与创作草图，揭示永恒的追求',
        icon: '🗝️',
        order: 9,
        type: 'clue',
        targetId: 'clue_shared_2',
        isCompleted: false,
        hint: '需要同时拥有编钟乐谱和油画',
        relatedClueIds: ['clue_shared_2']
      },
      {
        id: 'kp_ch4_10',
        chapterId: 'chapter_4',
        name: '联动机关·千年永恒锁',
        description: '解开最终联动机关，答案是"永恒"',
        icon: '✨',
        order: 10,
        type: 'mechanism',
        targetId: 'mech_linked_final',
        isCompleted: false,
        hint: '历史与艺术的交汇处，是爷爷想要告诉你的答案',
        relatedMechanismIds: ['mech_linked_final'],
    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_5',
        name: '文物鉴定室',
        description: '进入专业的文物鉴定工作室，配备放大镜、紫外灯等专业设备',
        icon: '🔬',
        order: 1,
        type: 'exhibition',
        targetId: 'exhibition_auth_1',
        isCompleted: false,
        hint: '先收集鉴定工具，再开始鉴定工作',
      ...
      },
      {
        ...
        chapterId: 'chapter_5',
        name: '收集鉴定工具',
        description: '收集爷爷的鉴定笔记、专用放大镜、紫外荧光灯、收藏证书',
        icon: '🧰',
        order: 2,
        type: 'clue',
        targetId: 'clue_auth_1',
        isCompleted: false,
        hint: '鉴定室里散落着各种专业鉴定工具',
        relatedClueIds: ['clue_auth_1', 'clue_auth_2', 'clue_auth_3', 'clue_auth_4'],
        exhibitionId: 'exhibition_auth_1'
      },
      {
        id: 'kp_ch5_3',
        chapterId: 'chapter_5',
        name: '藏品真伪鉴定',
        description: '运用专业知识，鉴定四件珍贵藏品的真伪',
        icon: '🔍',
        order: 3,
        type: 'mechanism',
        targetId: 'mech_authenticity',
        isCompleted: false,
        hint: '仔细检查每件藏品的细节，做出正确判断',
        relatedMechanismIds: ['mech_authenticity'],
        exhibitionId: 'exhibition_auth_1'
      },
      {
        id: 'kp_ch5_4',
        chapterId: 'chapter_5',
        name: '推导四位密码',
        description: '根据每件藏品的鉴定结果，按照顺序推导四位密码6104',
        icon: '🔢',
        order: 4,
        type: 'story',
        targetId: 'clue_auth_final',
        isCompleted: false,
        hint: '正确判断真伪后会获得对应的数字和位置线索',
        relatedClueIds: ['clue_auth_final']
      },
      {
        id: 'kp_ch5_5',
        chapterId: 'chapter_5',
        name: '爷爷的珍藏密室',
        description: '密码正确，珍藏密室的大门缓缓打开',
        icon: '🚪',
        order: 5,
        type: 'exhibition',
        targetId: 'exhibition_auth_final',
        isCompleted: false,
        hint: '进入密室，了解爷爷的终极秘密',
      ...
      },
      {
        ...
        chapterId: 'chapter_5',
        name: '爷爷的终极秘密',
        description: '密码"永恒"开启了爷爷留下的终极秘密',
        icon: '✨',
        order: 6,
        type: 'mechanism',
        targetId: 'mech_auth_final',
        isCompleted: false,
        hint: '爷爷一生追求的答案...',
        relatedMechanismIds: ['mech_auth_final'],
        exhibitionId: 'exhibition_auth_final'
      },
      {
        id: 'kp_ch5_7',
        chapterId: 'chapter_5',
        name: '记忆回廊开启',
        description: '通往记忆回廊的大门缓缓开启，最终的篇章即将开始',
        icon: '🌟',
        order: 7,
        type: 'story',
        targetId: 'chapter_6',
    ...
    keyPoints: [
      {
        ...
        chapterId: 'chapter_6',
        name: '记忆回廊入口',
        description: '幽深的记忆回廊在眼前延伸，墙上镶嵌着无数发光的记忆碎片',
        icon: '🚪',
        order: 1,
        type: 'exhibition',
        targetId: 'exhibition_corridor_entrance',
        isCompleted: false,
        hint: '找到回廊钥匙，开启记忆之门',
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '开启记忆回廊',
        description: '密码"记忆"开启了记忆回廊的大门',
        icon: '✨',
        order: 3,
        type: 'mechanism',
        targetId: 'mech_cor_entrance',
        isCompleted: false,
        hint: '回廊钥匙上刻着的两个字',
        relatedMechanismIds: ['mech_cor_entrance'],
        relatedClueIds: ['clue_cor_1'],
        exhibitionId: 'exhibition_corridor_entrance'
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '童年记忆·向日葵花田',
        description: '穿越回琥珀的童年时光，金色的向日葵花田在阳光下闪耀',
        icon: '🌻',
        order: 4,
        type: 'exhibition',
        targetId: 'exhibition_corridor_childhood',
        isCompleted: false,
        hint: '收集童年的记忆碎片',
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '童年记忆排序',
        description: '将向日葵花语和蝴蝶标本按时间顺序排列',
        icon: '🧩',
        order: 5,
        type: 'mechanism',
        targetId: 'mech_cor_memory_1',
        isCompleted: false,
        hint: '按照记忆的时间顺序排列碎片',
        relatedMechanismIds: ['mech_cor_memory_1'],
        relatedClueIds: ['clue_cor_2', 'clue_cor_3'],
        exhibitionId: 'exhibition_corridor_childhood'
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '青春抉择·十字路口',
        description: '站在人生的十字路口，大学录取通知书和艺术学院邀请函在手中',
        icon: '🎓',
        order: 6,
        type: 'exhibition',
        targetId: 'exhibition_corridor_youth',
        isCompleted: false,
        hint: '收集青春时期的记忆碎片',
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '第一次人生抉择',
        description: '面对影响一生的选择：重点大学还是艺术梦想？',
        icon: '🤔',
        order: 7,
        type: 'mechanism',
        targetId: 'mech_cor_branch_1',
        isCompleted: false,
        hint: '你的选择将影响最终的结局',
        relatedMechanismIds: ['mech_cor_branch_1'],
        relatedClueIds: ['clue_cor_4', 'clue_cor_5'],
        exhibitionId: 'exhibition_corridor_youth'
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '此刻重逢·记忆核心',
        description: '回到现在，四周漂浮着所有收集到的记忆碎片',
        icon: '🌟',
        order: 8,
        type: 'exhibition',
        targetId: 'exhibition_corridor_present',
        isCompleted: false,
        hint: '收集最后的记忆碎片',
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '完整记忆拼图',
        description: '将所有记忆碎片按时间顺序重新排列',
        icon: '🧠',
        order: 9,
        type: 'mechanism',
        targetId: 'mech_cor_memory_final',
        isCompleted: false,
        hint: '从童年到现在，按照时间顺序排列8块记忆碎片',
        relatedMechanismIds: ['mech_cor_memory_final'],
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '最终的抉择',
        description: '面对最后的选择：守护记忆还是顺其自然？',
        icon: '💫',
        order: 10,
        type: 'mechanism',
        targetId: 'mech_cor_branch_final',
        isCompleted: false,
        hint: '这个选择将决定最终的结局',
        relatedMechanismIds: ['mech_cor_branch_final'],
        relatedClueIds: ['clue_cor_6', 'clue_cor_7', 'clue_cor_8'],
        exhibitionId: 'exhibition_corridor_present'
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '结局之门',
        description: '金色光芒笼罩，通往结局的大门缓缓打开',
        icon: '🚪',
        order: 11,
        type: 'exhibition',
        targetId: 'exhibition_corridor_ending',
        isCompleted: false,
        hint: '准备揭开最终的结局',
      ...
      },
      {
        ...
        chapterId: 'chapter_6',
        name: '永恒的答案',
        description: '密码"永恒"解开了最终的结局',
        icon: '✨',
        order: 12,
        type: 'mechanism',
        targetId: 'mech_cor_ending',
        isCompleted: false,
        hint: '当所有记忆归位，答案就是永恒',
        relatedMechanismIds: ['mech_cor_ending'],
        relatedClueIds: ['clue_cor_8'],
        exhibitionId: 'exhibition_corridor_ending'
      }
    ]
  }
